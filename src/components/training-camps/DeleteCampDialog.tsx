...
export function DeleteCampDialog({ kemId }: { kemId: string }) {
  const { t } = useLanguage();
  ...
  async function handleDelete() {
    ...
    try {
      ...
      toast.success("Kem latihan berjaya dipadam.");
      setOpen(false);
      router.push("/training-camps");
      router.refresh();
    } catch {
    ...
    <Dialog open={open} onOpenChange={setOpen}>
      ...
      <DialogContent>
        <DialogHeader>
          ...
          <DialogDescription>
            {t.trainingCamp.confirmDeleteMsg}
          </DialogDescription>
        </DialogHeader>
        <DialogFooter>
